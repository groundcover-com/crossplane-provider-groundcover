...
func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for groundcover").DefaultEnvars()
	...
	o := tjcontroller.Options{
		...
		// Required by the terraform-plugin-framework connectors (the generated controllers
		// pass o.OperationTrackerStore); without it Connect panics on a nil store.
		OperationTrackerStore: tjcontroller.NewOperationStore(log),
		SetupFn:               clients.TerraformSetupBuilder("dev"),
	}
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup groundcover controllers")
